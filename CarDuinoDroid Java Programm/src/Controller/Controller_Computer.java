...
public class Controller_Computer {
	...
	public Performance_Analyzer performance_Analyzer;  //GB
	...
	public Controller_Computer(Log LOG, GUI_Computer GUI_computer, GPSTrack gpsTrack) {
		...
		performance_Analyzer = new Performance_Analyzer(this); //GB
		network=new Network(packagedata,camera_picture, performance_Analyzer,this);  //GB
