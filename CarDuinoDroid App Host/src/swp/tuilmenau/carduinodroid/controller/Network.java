...
public class Network
{
	...
	Socket_Performance_Analyzer Socket_Performance_Analyzer; //GB
	...
	{		
		...
		t2.start();
		//GB
		Socket_Performance_Analyzer = new Socket_Performance_Analyzer(controller, this);
		Log.e("hauptporg","t3 wird gestartet");
		t3 = new Thread(Socket_Performance_Analyzer,"socketperformanceanalyzer");
		t3.start();  
	}
